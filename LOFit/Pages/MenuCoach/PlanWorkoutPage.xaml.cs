...
[QueryProperty(nameof(WorkoutsList), "WorkoutsList")]
[QueryProperty(nameof(Plan), "Plan")]
public partial class PlanWorkoutPage : ContentPage
{
    ...
    List<List<WorkoutDayModel>> _list;
    public List<List<WorkoutDayModel>> WorkoutsList
    {
        get { return _list; }
        set
        {
    ...
    public PlanWorkoutPage(IWorkoutsRestService dataService, IMeasurementRestService dataServiceMeasurement, ICoachRestService dataServiceCoach, IUserRestService dataServiceUser, IPlanRestService dataServicePlan)
    {
        InitializeComponent();
    ...
    void ListLoad()
    {
        collectionViewCoach.ItemsSource = ListModelTools.ReturnWorkoutDayList(_list[_day - 1]);
    }
    ...
    async void OnAddButtonClicked(object sender, EventArgs e)
    {
        ...
        var navigationParameter = new Dictionary<string, object>
        {
            { nameof(WorkoutDayModel), new WorkoutDayModel(){ Id_planu = id, Data_czas = DateTime.Now} },
